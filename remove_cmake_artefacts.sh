...
while [[ $# -gt 0 ]]; do
  ...
  case $1 in
    --help)
      ...
      cat << EOF
Pantheios.Extras.xHelpers is a small, header-only C and C++ library that supplements Pantheios by providing general-purpose handling of exceptions such that they do not cross link-unit boundaries
